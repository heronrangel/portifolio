...
const projetos = {
  ...
  '4': {
    ...
    descricaoCompleta: 'Solução de integração entre ERP e plataformas de e-commerce. Desenvolvida em VBA Access, essa solução conecta o sistema interno de gestão a lojas virtuais como WooCommerce, Bagy e NuvemShop. A integração via API inclui atualização de preços, estoque e importação de pedidos, garantindo praticidade e a redução de retrabalho.',
    imagens: [
  ...
  '5': {
    ...
    descricaoCompleta: 'Esse software lê um arquivo XML contendo uma fila de arquivos a serem compactados e enviados como backup. Após o processamento, os arquivos são transmitidos via FTP para o servidor do sistema ERP.',
    imagens: [
    ...
    descricaoCompleta: 'Esse software centraliza toda a estrutura necessária para a instalação do sistema ERP, incluindo o registro de DLLs e demais utilitários essenciais. Além disso, oferece recursos para migração e atualização completa do sistema.',
    imagens: [
    ...
    descricaoCompleta: 'Esse software monitora, de hora em hora, a pasta local de backups, evitando a ocupação excessiva do disco rígido, mantendo apenas uma quantidade definida de arquivos e garantindo que sempre permaneçam armazenados os backups mais recentes.',
    imagens: [
    ...
    descricaoCompleta: 'Esse software facilita o gerenciamento de arquivos e versões de um sistema ERP, sendo possível criar uma lista de processos que devem ser executados, como o envio de arquivos para um servidor SFTP, bem como, é possível definir se o arquivo será compactado antes do envio ou enviado em seu formato original.',
    imagens: [
  ...
  '13': {
    ...
    descricaoCurta: 'Site Central de Ajuda',
